...
- (void)setupUI {
    ...
    [_flagButton setBackgroundImage:[UIImage imageNamed:@"hongqi"] forState:(UIControlStateNormal)];
    ...
    [_normalButton setBackgroundImage:[UIImage imageNamed:@"fk_normal"] forState:(UIControlStateNormal)];
    ...
    [_questionButton setBackgroundImage:[UIImage imageNamed:@"wenhao"] forState:(UIControlStateNormal)];
