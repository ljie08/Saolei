...
- (void)setRestartKind:(RestartKind)restartKind {
    ...
    switch (restartKind) {
        case RestartKindNormal:
            [_restartButton setBackgroundImage:[UIImage imageNamed:@"normal"] forState:(UIControlStateNormal)];
            
            [_restartButton setBackgroundImage:[UIImage imageNamed:@"normal"] forState:(UIControlStateHighlighted)];
            break;
        case RestartKindWin:
            [_restartButton setBackgroundImage:[UIImage imageNamed:@"win"] forState:(UIControlStateNormal)];
            break;
        case RestartKindLose:
            [_restartButton setBackgroundImage:[UIImage imageNamed:@"lose"] forState:(UIControlStateNormal)];
            break;
    }
}
